...
from utils.ap import compute_average_precision
...
def main(args):
    ...
    train_dataset = Dataset_Data(phase='train', image_size=image_size)
    val_dataset = Dataset_Data(phase='val', image_size=image_size)
    ...
    for epoch in range(n_epoch):
        ...
        val_ap = compute_average_precision(target_dict, output_dict)
        log_text += "val loss: {:.4f}, val acc: {:.4f}, val auc: {:.4f}, val ap: {:.4f}".format(
...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', '--config', action='store_true',
                        default='src/configs/sbi/base.json')  # src/configs/sbi/base.json
